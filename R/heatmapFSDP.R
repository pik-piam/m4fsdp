  ...
  if (tableType == 1) {
    ...
    scenGrouping <-
      c("SSP2 2050::A|<b>Ref SSP2 2050</b>",
        "Sufficiency::Diet|<b>Diet</b>",
        "DietEmptyCals::Diet|LowEmptyCals",
        "DietFish::Diet|BalancedFish",
        "DietLegumes::Diet|HighLegumes",
        "DietMonogastrics::Diet|LowMonogastrics",
        "DietRuminants::Diet|LowRuminants",
        "DietVegFruitsNutsSeeds::Diet|HighVegFruitsNuts",
        "NoOverweight::Diet|NoOverweight",
        "HalfOverweight::Diet|HalfOverweight",
        "NoUnderweight::Diet|NoUnderweight",
        "LessFoodWaste::Diet|LowFoodWaste",
        ...
        "RiceMit::AgroMngmt|RiceMitigation",
