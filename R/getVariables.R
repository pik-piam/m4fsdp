...
getVariables <- function(reportVariables = NULL) {
  ...
  names(var) <- c("Health|1|Underweight|mio people|decrease|0|1",
                  ...
                  "Environment|4.1|Biodiversity|BII|increase|2|100",
                  "Environment|4.2|Ag Landscape Intactness|Biodiversity Intactness Index|increase|2|100",
                  "Environment|4.3|Biodiversity Hotspots|Biodiversity Intactness Index|increase|2|100",
