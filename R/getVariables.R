...
getVariables <- function(reportVariables = NULL) {
  ...
  names(var) <- c("Health|1|Underweight|Mio people|decrease|0|1",
                  ...
                  "Environment|4.3|Hotspot & Intact Landscapes|Biodiv. Intactness Index|increase|2|100",
                  ...
                  "Environment|8|AFOLU GHG Emissions|GtCO2eq/yr in AR6 GWP100|decrease|1|1",
