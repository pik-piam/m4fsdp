...
R package **m4fsdp**, version **0.29.10**
...
Bodirsky B, Dietrich J, Humpenoeder F (2023). _m4fsdp: MAgPIE outputs R package for MAgPIE version 4.x to create outputs for FSDP project_. doi: ? (URL: https://doi.org/?), R package version 0.29.10, <URL: https://github.com/pik-piam/m4fsdp>.
...
for FSDP project},
  ...
  year = {2023},
  note = {R package version 0.29.10},
  doi = {?},
