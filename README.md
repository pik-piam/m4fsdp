...
R package **m4fsdp**, version **0.27.2**
...
Bodirsky B, Dietrich J, Humpenoeder F (2022). _m4fsdp: MAgPIE outputs R package for MAgPIE version 4.x to create outputs for FSDP project_. doi:? <https://doi.org/%3F>, R package version 0.27.2, <https://github.com/pik-piam/m4fsdp>.
