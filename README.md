...
R package **m4fsdp**, version **0.43.15**
...
Bodirsky B, Dietrich J, Humpenoeder F, Chen D, Leip D (2023). _m4fsdp: MAgPIE outputs R package for MAgPIE version 4.x to create outputs for FSDP project_. doi: 10.5281/zenodo.7899913 (URL: https://doi.org/10.5281/zenodo.7899913), R package version 0.43.15, <URL: https://github.com/pik-piam/m4fsdp>.
...
for FSDP project},
  author = {Benjamin Leon Bodirsky and Jan Philipp Dietrich and Florian Humpenoeder and David Chen and Debbora Leip},
  year = {2023},
